...
var calcdis = "0";
var input = [ "", "", "", "255", "0", "0", "0", "0", "255", "0", "255", "0", "255", "255" ];                                                 // Textbox input
...
function setup() {
  console.log("Version 004: 5/5/2018");
...
function draw() {
  ...
  textbox(0, -410, 790, 50, 0, true, int(mode[1]/3)*2);                                     // Lower text box  Input slecected == 1
  ...
  textbox(0, -470, 790, 50, 7, true, 1+int(mode[2]/3));                                   // Upper text box  Input slecected == 2
  ...
  button("Example: Parametric", -533, 410, 204, 50, 40, false, 4, 0);
  button("Example: Parametric", -320, 410, 204, 50, 41, false, 4, 0);
  button("Example: Polar", -107, 410, 204, 50, 42, false, 4, 0);
  button("Example: Polar", 107, 410, 204, 50, 43, false, 4, 0); 
  button("Example: f(x)", 320, 410, 204, 50, 44, false, 4, 0);
  button("Example: f(x)", 533, 410, 204, 50, 45, false, 4, 0); 
  ...
  button("Settings and Information", 0, 470, 415, 50, 51, true, 3, 0); 
...
function button(buttontext, buttonx, buttony, buttonw, buttonh, buttonnum, highlight, highlightColor, buttonMode) {
  ...
  if (buttonnum >= 52 && buttonnum <= 60) {
    show[floor((buttonnum-52)/3)][(buttonnum-49)%3+2] = input[(buttonnum-49)];
  }
  if (highlightButton[buttonnum] == 1) {
    ...
    for (place = 0, i = 0; place < input.length; place++, i++) {    // Changes input formatting
      if (int(input.charAt(place)) >= 0 && int(input.charAt(place)) <= 9 || input.charAt(place) == 'p') {
        if (input.charAt(place) == 'p') {
          ...
          var digits = "";          
          while (place < input.length && (int(input.charAt(place)) >= 0 && int(input.charAt(place)) <= 9)) {
...
function popup() {
  ...
  textbox(-250, -264, 70, 30, 52, true, 3);
  textbox(-170, -264, 70, 30, 53, true, 3);
  textbox(-90, -264, 70, 30, 54, true, 3);
  textbox(-250, -210, 70, 30, 55, true, 3);
  textbox(-170, -210, 70, 30, 56, true, 3);
  textbox(-90, -210, 70, 30, 57, true, 3);
  textbox(-250, -156, 70, 30, 58, true, 3);
  textbox(-170, -156, 70, 30, 59, true, 3);
  textbox(-90, -156, 70, 30, 60, true, 3);
