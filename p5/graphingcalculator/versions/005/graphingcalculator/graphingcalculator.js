...
function setup() {
  console.log("Version 005: 5/6/2018");
...
function draw() {
  ...
  if (calculate[2] == 1) {
    calculate[0] = str("f(x) = "+prepareToSolve(float(functions[0][0][7]), calculate[1])+" @ x = "+input[14]);
  } else {
    calculate[0] = "";
  }
  ...
  textbox(0, 400, 1280, 50, 62, true, 3);
  ...
  button("Settings and Information", 0, 464, 350, 50, 51, true, 3, 0); 
