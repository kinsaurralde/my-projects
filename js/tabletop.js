(function() {
    ...
    /*
      Initialize with Tabletop.getSheetData( { key: '0AjAPaAU9MeLFdHUxTlJiVVRYNGRJQnRmSnQwTlpoUXc' } )
        OR!
      Initialize with Tabletop.getSheetData( { key: 'https://docs.google.com/spreadsheet/pub?hl=en_US&hl=en_US&key=0AjAPaAU9MeLFdHUxTlJiVVRYNGRJQnRmSnQwTlpoUXc&output=html&widget=true' } )
        OR!
      Initialize with Tabletop.getSheetData('0AjAPaAU9MeLFdHUxTlJiVVRYNGRJQnRmSnQwTlpoUXc')
    */
    ...
    Tabletop.getSheetData = function(options) {
      return new Tabletop(options);
    };
  
    Tabletop.sheets = function() {
      this.log('Times have changed! You\'ll want to use var tabletop = Tabletop.getSheetData(...); tabletop.sheets(...); instead of Tabletop.sheets(...)');
    };
