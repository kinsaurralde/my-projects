...
var calculate = [ "", 0, 0, "", "", ""];                                    // Display, inputSelected, type
...
function setup() {
  console.log("Version 006: 5/16/2018");
...
function draw() {
  ...
  if (calculate[2] == 1) {
    store(input[14],14);
    console.log(input[14], functions[0][0][27], inputSelected);
    calculate[0] = str("f("+input[14]+") = "+calcValue(float(functions[0][0][27]), calculate[1])+" @ x = "+input[14]);
  } else {
    if (calculate[2] == 2) {
      calculate[0] = str("dy/dx = "+calcSlope(mode[calculate[1]], float(functions[0][0][7])-float(1/100000), float(functions[0][0][7])+float(1/100000), calcValue(float(functions[0][0][7])-float(1/100000), calculate[1]), calcValue(float(functions[0][0][7])+float(1/100000), calculate[1]))+" @ x = "+input[14]);
    } else {
      calculate[0] = "";
    }
  }
